...
def cleaned_data(csv_string=None):
    ...
    if csv_string is not None:
        ...
        df = pd.read_csv(r'C:\Users\ASUS\Downloads\DepEdBigData-main\DepEdBigData-main\Desktop\[CMPE363] Big Data Analytics\data\SY 2023-2024 School Level Data on Official Enrollment 13.csv', encoding='latin-1', skiprows=4)
